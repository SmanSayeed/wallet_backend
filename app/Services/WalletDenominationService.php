...
class WalletDenominationService
{
    ...
    {
        return $this->walletBalanceService->addDenominationToWallet($walletId, $denominationId, $amount, $userId, $currencyId);
    }
    ...
    {
        return $this->walletBalanceService->removeDenominationFromWallet($walletId, $denominationPivotId, $userId);
    }
